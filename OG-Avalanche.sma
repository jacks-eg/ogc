...
#define V_MODEL "models/og_weapons/v_sfmg.mdl"
#define P_MODEL "models/og_weapons/p_sfmg.mdl"
#define W_MODEL "models/og_weapons/w_sfmg.mdl"
...
{
	"og_weapons/sfmg-1.wav",
	"og_weapons/sfmg_changea.wav",
	"og_weapons/sfmg_changeb.wav",
	"og_weapons/sfmg_clipin1.wav",
	"og_weapons/sfmg_clipin2.wav",
	"og_weapons/sfmg_clipout1.wav"
}
...
{
	register_native("og_avalanche", "Get_Avalanche", 1)
}
...
public fw_SetModel(entity, model[])
{
	...
	if(equal(model, AVALANCHE_OLDMODEL))
	{
		...
		if(Get_BitVar(g_Had_Avalanche, iOwner))
		{
			...
			engfunc(EngFunc_SetModel, entity, "models/w_m249.mdl")
